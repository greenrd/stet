...
$printargs = "default (found $count comments)";
...
#		    $showagree = "<a label=\"you have indicated that you agree with this\" name=\"you have indicated that you agree with this\">unagree</a>";
	    ...
	    $showagree = "<a href=\"http://gplv3.fsf.org:8800/launch/login_form?came_from=/stet/gpl3.xml\">login</a> to agree";
	}
...
# http://gplv3.fsf.org/stet/getnotes.pl?SearchId=new
Query=
