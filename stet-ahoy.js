...
// this is stet-ahoy.js, a part of Stet <http://stet.mdcclv.com/>
// a derivative work of ahoy.js:
...
// stet author: Orion Buckminster Montoya <orion@mdcclv.com>
// Latest version: <http://stet.mdcclv.com/>

//---------------------------------------------------
//------------------- Changes -----------------------
//---------------------------------------------------
//
// 2005-11-03 obm: updated FSF mailing address in license text, removed 
// existing 1-item changelog
// 
...
// since we're doing multiple highlights and getting the query data
// via XMLHTTPRequest, we don't need this function.
...
function ahyObjAnchor()
{
	...
	// Stet doesn't want to do this, because numeric ranges are
	// anathema if the document changes.
        //---------------------------------------------------
        //- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - 
